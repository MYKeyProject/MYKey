 ...
 * @author Bae Jinshik
 * 
 *         KeySequence contains KeyButtons... So when user justify a Consonant
 *         which made by clicked different Keys It has a information of all
 *         thing about Justified Consonant
 */
public class KeySequence extends JPanel implements MouseListener,
	...
	public void appendKeyButtons(KeyButton btn) {
		...
		if (MYKeyManager.getManager().getKeySequence() != null
			...
			keyButtons.get(keyButtons.size() - 1).addSequenceNum(
					keyButtons.size());
		}
	}
