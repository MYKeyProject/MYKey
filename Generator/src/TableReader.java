...
public class TableReader {
	...
	public TableReader(String tablePath, String xmlPath, String javaPath) {
		try {
			...
			tableReader = new BufferedReader(new InputStreamReader(tableFile,"UTF-8"));
			
			/*
			 * need function for readTable
			 * readTable();
			 */
	...
	/**
	 * read Table for XML and Java generate
	 * modifying... 2014.09.03
	 */
